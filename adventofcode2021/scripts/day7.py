...
def solve_part_1(input):
    ...
    print(
        "For part 1, the minimum fuel between {} and {} is {} obtain for position {}".format(
            q1, q3, min_fuel, q1 + fuel.index(min_fuel)
        )
    )
    print(
        "For part 2, the minimum fuel between {} and {} is {} obtain for position {}".format(
            q1, q3, min_fuel_2, q1 + fuel_2.index(min_fuel_2)
        )
    )
