...
def find_next_locations(matrix, bassin, x, y):
    ...
    down = x
    while (
        down < matrix.shape[0] - 1
        and matrix[down + 1, y] > matrix[down, y]
        and matrix[down + 1, y] != 9
    ):
        print("down")
    ...
    left = y
    while (
        left > 0 and matrix[x, left - 1] > matrix[x, left] and matrix[x, left - 1] != 9
    ):
        print("left")
    ...
    while (
        ...
        and matrix[x, right + 1] > matrix[x, right]
        and matrix[x, right + 1] != 9
    ):
        print("right")
